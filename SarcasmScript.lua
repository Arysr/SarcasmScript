...
menu.action(labelpresets_root, "Execute Script", {}, "Will probably freeze your game for a good moment and kick you out of your lobby. Low end users beware.", function(on_click)
    do_label_preset("TICK_DIED", "~a~~HUD_COLOUR_WHITE~ fucking died.")
	do_label_preset("TICK_LEFT", "~a~~HUD_COLOUR_WHITE~ wised up and left.")
	do_label_preset("HUD_LBD_FMF", "AIDS Online (walter whjit, ~1~)")
    do_label_preset("HUD_LBD_FMP", "AIDS Online (Pubic, ~1~)")
	...
	do_label_preset("PCARD_CLEAN_PLAYER", "Moron")
	do_label_preset("PCARD_DRIVING", "Skill possessed for the operation of an automobile")
	...
	do_label_preset("PCARD_ONLINE_SP", "Watching Micheal fight with Amanda.")
	...
	do_label_preset("WTD_RAYPISTOL", "If you pvp with this thing go fuck yourself")
	...
	do_label_preset("RANK_GFM_21", "Been playing for way too long")
	...
	do_label_preset("HUD_INPUT85", "SAY NO TO MAP RIGHTS")
	do_label_preset("GOODBOYRMDR", "Alert: EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE")
	...
	do_label_preset("PCARD_STEALTH", "how loud are they")
	do_label_preset("PCARD_STEALTH_0", "LOUD AS FUCK")
	do_label_preset("PCARD_STEALTH_1", "LOUD AS FUCK")
	do_label_preset("PCARD_STEALTH_2", "LOUD AS FUCK")
	do_label_preset("PCARD_STEALTH_3", "LOUD AS FUCK")
	do_label_preset("PCARD_STEALTH_4", "LOUD AS FUCK")
